...
function execute($bininstr) {
    ...
    switch($instr) {
        ...
        case 1:
            ...
            $_SESSION['instr_ptr'] = $_SESSION['instr_ptr'] + 1;
            $_SESSION['log'] .= "$instr/$addr: [S] = [S] + Memory[$addr]\n";
            $_SESSION['changes']['reg_s'] = 1;
            break;
        case 2:
            $_SESSION['mem'][$addr] = $_SESSION['reg_a'];
            $_SESSION['instr_ptr'] = $_SESSION['instr_ptr'] + 1;
            $_SESSION['log'] .=  "$instr/$addr: Memory[$addr] = [A]\n";
        ...
        case 3:
            ...
            $_SESSION['instr_ptr'] = $_SESSION['instr_ptr'] + 1;
            $_SESSION['log'] .= "$instr/$addr: Memory[$addr] = [S]; [A] = [S];\n";
            $_SESSION['changes']['reg_a'] = 1;
            $_SESSION['changes']['memory'] = 1;
            break;
        case 4:
        ...
        case 10:
            ...
            $_SESSION['reg_a'] = 0;
            $_SESSION['instr_ptr'] = $_SESSION['instr_ptr'] + 1;
            $_SESSION['log'] .= "$instr/$addr: Memory[$addr] = [A]; [A] = 0;\n";
            $_SESSION['changes']['reg_a'] = 1;
            $_SESSION['changes']['memory'] = 1;
            break;
        case 11 :
            ...
            $_SESSION['reg_a'] = 0;
            $_SESSION['instr_ptr'] = $_SESSION['instr_ptr'] + 1;
            $_SESSION['log'] .= "$instr/$addr: Memory[$addr] = [S]; [A] = 0;\n";
            $_SESSION['changes']['reg_a'] = 1;
            $_SESSION['changes']['memory'] = 1;
            break;
        case 12:
        ...
        case 15:
            ...
            break;
        default :
            $_SESSION['log'] .= "$instr/$addr: ERROR: Unknown instructions!\n";
            break;
    }
    return $return_value;
}
